...
<!--          <a class="p-2 text-muted" href="#">Culture</a>
        ...
        <div class="jumbotron p-3 p-md-5 text-white rounded " style="background-color: #AB6949;">
        <div class="col-md-6 px-0" >
            <center> <h1 class="display-4 font-italic">Destaque Do Dia</h1></center>
          <p class="lead my-3">Confira os destaques do dia..</p>
          <p class="lead mb-0"><a href="#" class="text-white font-weight-bold">Veja o destaques...</a></p>
        </div>
      </div>
